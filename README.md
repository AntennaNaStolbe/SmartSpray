...
// Скорость работы мотора. Подстраивается подбором, так как каждый освежитель имеет свой люфт в механизме. Необходимо подобрать минимальное значение от 0 до 255, при котором хватает мощности для распыления. Скорее всего подойдет стандартное (188)
int motorPower = 188;
```
...
2. Добавление web-морды, внутри которой можно выполнить настройки подключения к wi-fi, mqtt, выполнить "пшик", сбросить счетчик пшиков, установить нужный процент балона и тд
